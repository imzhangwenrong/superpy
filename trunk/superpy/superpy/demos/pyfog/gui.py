"""Pyfog is an application to create a cloud of popular words from many inputs.
"""

import logging
import Pmw

from superpy.SuperWatch import SPWidgets

def MakeMainPyFogWindow(rootWindow, defaults):
    """Make the main pyfog window.
